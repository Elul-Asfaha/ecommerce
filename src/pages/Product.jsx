...
const Product = () => {
    ...
    const handleAddToCart = () => {
        // this functions adds the order from the products page to the cart
        const addCart = {
            Id: Number(id),
            Color: details[0].color[color - 1],
            Amount: amount,
        };
    ...
    return (
        <div>
            <Nav />
            <div className='flex flex-col lg:grid mt-[2%] lg:grid-cols-2 gap-5 px-[5%]'>
                ...
                <div className='flex flex-col my-5'>
                    <div className='flex flex-col gap-4 border-b py-5'>
                        ...
                        <div className='flex items-center gap-1 text-2xl'>
                            {ratingDisp}
                            <p>({details[0].reviews && details[0].reviews})</p>
                        </div>
                    </div>
                    ...
                    <div className='flex my-5'>
                        ...
                        <div className='flex-1 flex flex-col m-2 justify-evenly'>
                            ...
                            <p>
                                Enter your postal code for delivery avalibility
                            </p>
                        </div>
                    </div>
                    <div className='flex'>
